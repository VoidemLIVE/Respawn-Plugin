package net.greenwoodmc.respawnplugin.util.colour;

import com.google.common.collect.ImmutableMap;
import net.greenwoodmc.respawnplugin.util.colour.patterns.GradientPattern;
import net.greenwoodmc.respawnplugin.util.colour.patterns.Pattern;
import net.greenwoodmc.respawnplugin.util.colour.patterns.RainbowPattern;
import net.greenwoodmc.respawnplugin.util.colour.patterns.SolidPattern;
